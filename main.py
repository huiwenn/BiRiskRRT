...
def main(data_name, map_name, bidirectional=True, having_pedestrian=True):
    ...
    for i in range(experiment_times):
        ...
        # ----------------------------------
        # save traj into pickle file
        if bidirectional:
            traj_name = 'bi_traj_' + map_name + '_' + data_name + str(i) + '.pkl'
        else:
            traj_name = 'traj_' + map_name + '_' + data_name + str(i) + '.pkl'
        with open(os.path.join(dataset_path, traj_name), 'wb') as f:
            pickle.dump(traj, f)
        # ----------------------------------
